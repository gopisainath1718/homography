...
original_transformed_pose = "/home/rainier/ros2_ws/src/littleslam_ros2/homography scripts/converted_pose_pixels_fury.csv"        # Input 2
new_transformed_pose = "/home/rainier/ros2_ws/src/littleslam_ros2/homography scripts/converted_pose_pixels_fury.csv"              # Input 3
output_image_path = "comparison_overlay.png"

# === COLORS & DRAW CONFIG ===
COLOR_ORIGINAL = (0, 0, 255)      # Green
COLOR_NEW = (0, 0, 255)         # blue
POINT_RADIUS = 2
LINE_THICKNESS = 2
