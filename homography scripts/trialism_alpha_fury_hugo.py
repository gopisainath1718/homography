...
fury_pose_path = "/home/rainier/ros2_ws/src/littleslam_ros2/homography scripts/converted_pose_pixels_hugo.csv"
hugo_pose_path = "/home/rainier/ros2_ws/src/littleslam_ros2/homography scripts/converted_pose_pixels_fury.csv"
output_path = "triple_path_overlay.png"

# === COLORS ===
COLOR_ALPHA = (0, 255, 0)    # Green
COLOR_FURY = (255, 0, 0)     # Softer red
COLOR_HUGO = (255, 0, 255)     # Blue

POINT_RADIUS = 2
LINE_THICKNESS = 2
FURY_LINE_THICKNESS = 1      # Thinner red line
...
fury_raw_path = read_coords(fury_pose_path)
hugo_raw_path = read_coords(hugo_pose_path)

# Apply homography transforms
fury_path = apply_homography(fury_raw_path, H_FURY)
hugo_path = apply_homography(hugo_raw_path, H_HUGO)
...
print(f"[✅] Saved triple overlay image to: {output_path}")
